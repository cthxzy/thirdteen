list="#A #2 #3 #4 #5 #6 &10 &6 &7 *9 *8 *7 *5"
import sys
def fengdun (argv):
    mypai=argv[1:]
    #检验2行
    ...
    if dunlistlength==0:
        ...
        if len(dunlist[0])<5:
            ...
            pass
    #jieguo=[]
    #str=dunlist[2][0]+" "+dunlist[2][1]+" "+dunlist[2][2]
    #jieguo.append(str)
    #str = dunlist[1][0] + " " + dunlist[1][1] + " "+dunlist[1][2]+ " " + dunlist[1][3] + " "+dunlist[1][4]
    #jieguo.append(str)
    #str = dunlist[0][0] + " " + dunlist[0][1] + " "+dunlist[0][2] + " " + dunlist[0][3] + " "+dunlist[0][4]
    #jieguo.append(str)
    jieguo=dunlist[2][0]+" "+dunlist[2][1]+" "+dunlist[2][2]+ " "+dunlist[1][0] + " " + dunlist[1][1] + " "+dunlist[1][2]+ " " + dunlist[1][3] + " "+dunlist[1][4]+ " "+dunlist[0][0] + " " + dunlist[0][1] + " "+dunlist[0][2] + " " + dunlist[0][3] + " "+dunlist[0][4]

    return jieguo
print(sys.argv)
print(fengdun(sys.argv))
